...
I read *Tracers in the Dark*[^tracers] while working on [VADER]({{ "/publications/vader-dead-drop-resolver/" | relative_url }}) (also highligned in [Spycraft 2.0]({{ "/blog/spycraft-2-0/" | relative_url }})), and it stuck with me that I needed to go deeper on the Bitcoin transaction data behind that work.
